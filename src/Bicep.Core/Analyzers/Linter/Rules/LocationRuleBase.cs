...
namespace Bicep.Core.Analyzers.Linter.Rules
{
    public abstract class LocationRuleBase : LinterRuleBase
    {
        ...
        {
            if (model.Compilation.SourceFileGrouping.TryGetSourceFileForSyntax(moduleDeclarationSyntax).IsSuccess(out var sourceFile) && sourceFile is BicepFile bicepFile)
            {
        ...
        )
        {
            ...
            if (fileSemanticModel.Compilation.SourceFileGrouping.TryGetSourceFileForSyntax(moduleDeclarationSyntax).IsSuccess(out var sourceFile) && sourceFile is BicepFile bicepFile)
            {
